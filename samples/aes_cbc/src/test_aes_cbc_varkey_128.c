...
#include "aes128_cbc_varkey_01.h"
#endif
#if defined(CONFIG_AES_CBC_VARKEY_128_02)
#include "aes128_cbc_varkey_02.h"
#endif
#if defined(CONFIG_AES_CBC_VARKEY_128_03)
#include "aes128_cbc_varkey_03.h"
#endif
#if defined(CONFIG_AES_CBC_VARKEY_128_04)
#include "aes128_cbc_varkey_04.h"
#endif
#if defined(CONFIG_AES_CBC_VARKEY_128_05)
#include "aes128_cbc_varkey_05.h"
#endif
#if defined(CONFIG_AES_CBC_VARKEY_128_06)
#include "aes128_cbc_varkey_06.h"
#endif

/* Shared encrypt+decrypt+compare logic as a macro to avoid
 * repeating the cipher session boilerplate 6 times          */
...
#if defined(CONFIG_AES_CBC_VARKEY_128_01)
    RUN_CBC_BATCH(CBC_VarKey_128_KAT_Test_Vectors_01,
                  cbc_varkey_128_kat_vectors_01,
                  cbc_varkey_128_kat_vectors_01_count,
                  "CBC VARKEY 128-01");
#endif
#if defined(CONFIG_AES_CBC_VARKEY_128_02)
    RUN_CBC_BATCH(CBC_VarKey_128_KAT_Test_Vectors_02,
                  cbc_varkey_128_kat_vectors_02,
                  cbc_varkey_128_kat_vectors_02_count,
                  "CBC VARKEY 128-02");
#endif
#if defined(CONFIG_AES_CBC_VARKEY_128_03)
    RUN_CBC_BATCH(CBC_VarKey_128_KAT_Test_Vectors_03,
                  cbc_varkey_128_kat_vectors_03,
                  cbc_varkey_128_kat_vectors_03_count,
                  "CBC VARKEY 128-03");
#endif
#if defined(CONFIG_AES_CBC_VARKEY_128_04)
    RUN_CBC_BATCH(CBC_VarKey_128_KAT_Test_Vectors_04,
                  cbc_varkey_128_kat_vectors_04,
                  cbc_varkey_128_kat_vectors_04_count,
                  "CBC VARKEY 128-04");
#endif
#if defined(CONFIG_AES_CBC_VARKEY_128_05)
    RUN_CBC_BATCH(CBC_VarKey_128_KAT_Test_Vectors_05,
                  cbc_varkey_128_kat_vectors_05,
                  cbc_varkey_128_kat_vectors_05_count,
                  "CBC VARKEY 128-05");
#endif
#if defined(CONFIG_AES_CBC_VARKEY_128_06)
    RUN_CBC_BATCH(CBC_VarKey_128_KAT_Test_Vectors_06,
                  cbc_varkey_128_kat_vectors_06,
                  cbc_varkey_128_kat_vectors_06_count,
                  "CBC VARKEY 128-06");
#endif
