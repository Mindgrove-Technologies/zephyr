...
#if defined(CONFIG_AES_CBC_VARTXT_128_01)
    RUN_CBC_BATCH(CBC_VarTxt_128_KAT_Test_Vectors_01,
                  cbc_vartxt_128_kat_vectors_01,
                  cbc_vartxt_128_kat_vectors_01_count,
                  "CBC VARTXT 128-01");
#endif
#if defined(CONFIG_AES_CBC_VARTXT_128_02)
    RUN_CBC_BATCH(CBC_VarTxt_128_KAT_Test_Vectors_02,
                  cbc_vartxt_128_kat_vectors_02,
                  cbc_vartxt_128_kat_vectors_02_count,
                  "CBC VARTXT 128-02");
#endif
#if defined(CONFIG_AES_CBC_VARTXT_128_03)
    RUN_CBC_BATCH(CBC_VarTxt_128_KAT_Test_Vectors_03,
                  cbc_vartxt_128_kat_vectors_03,
                  cbc_vartxt_128_kat_vectors_03_count,
                  "CBC VARTXT 128-03");
#endif
#if defined(CONFIG_AES_CBC_VARTXT_128_04)
    RUN_CBC_BATCH(CBC_VarTxt_128_KAT_Test_Vectors_04,
                  cbc_vartxt_128_kat_vectors_04,
                  cbc_vartxt_128_kat_vectors_04_count,
                  "CBC VARTXT 128-04");
#endif
#if defined(CONFIG_AES_CBC_VARTXT_128_05)
    RUN_CBC_BATCH(CBC_VarTxt_128_KAT_Test_Vectors_05,
                  cbc_vartxt_128_kat_vectors_05,
                  cbc_vartxt_128_kat_vectors_05_count,
                  "CBC VARTXT 128-05");
#endif
#if defined(CONFIG_AES_CBC_VARTXT_128_06)
    RUN_CBC_BATCH(CBC_VarTxt_128_KAT_Test_Vectors_06,
                  cbc_vartxt_128_kat_vectors_06,
                  cbc_vartxt_128_kat_vectors_06_count,
                  "CBC VARTXT 128-06");
#endif
