...
/* Zephyr's MMT suite typically bundles sizes or filters them via top-level selection */
#include "aes128_ctr_mmt.h"
#include "aes192_ctr_mmt.h"
#include "aes256_ctr_mmt.h"
#endif

/* --- 2. The Unified CTR MMT Test Macro --- */
...
#if defined(CTR_MMT_128_KAT_Test_Vectors) || defined(ctr_mmt_128_kat_vectors)
...
#if defined(CTR_MMT_192_KAT_Test_Vectors) || defined(ctr_mmt_192_kat_vectors)
...
#if defined(CTR_MMT_256_KAT_Test_Vectors) || defined(ctr_mmt_256_kat_vectors)
