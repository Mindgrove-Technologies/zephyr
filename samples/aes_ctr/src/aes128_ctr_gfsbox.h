#ifndef AES_128_CTR_GFSBOX_TESTVECTORS_H
#define AES_128_CTR_GFSBOX_TESTVECTORS_H
...
typedef struct {
    ...
    uint16_t    ct_len;
    uint8_t     mode;
} CTR_GFSbox_128_KAT_Test_Vectors;

/* CTR 128-bit GFSBOX — 14 test vectors */
static const CTR_GFSbox_128_KAT_Test_Vectors ctr_gfsbox_128_kat_vectors[] = {

    /* ── CTR_GFSBOX_128_KAT_01 ── */
    {
        .test_id    = "CTR_GFSBOX_128_KAT_01",
        .key        = {
    ...
    /* ── CTR_GFSBOX_128_KAT_02 ── */
    {
        .test_id    = "CTR_GFSBOX_128_KAT_02",
        .key        = {
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
        },
        .key_len    = 16,
    ...
    /* ── CTR_GFSBOX_128_KAT_03 ── */
    {
        .test_id    = "CTR_GFSBOX_128_KAT_03",
        .key        = {
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
        },
        .key_len    = 16,
    ...
    /* ── CTR_GFSBOX_128_KAT_04 ── */
    {
        .test_id    = "CTR_GFSBOX_128_KAT_04",
        .key        = {
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
        },
        .key_len    = 16,
    ...
    /* ── CTR_GFSBOX_128_KAT_05 ── */
    {
        .test_id    = "CTR_GFSBOX_128_KAT_05",
        .key        = {
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
        },
        .key_len    = 16,
    ...
    /* ── CTR_GFSBOX_128_KAT_06 ── */
    {
        .test_id    = "CTR_GFSBOX_128_KAT_06",
        .key        = {
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
        },
        .key_len    = 16,
    ...
    /* ── CTR_GFSBOX_128_KAT_07 ── */
    {
        .test_id    = "CTR_GFSBOX_128_KAT_07",
        .key        = {
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
        },
        .key_len    = 16,
    ...
    /* ── CTR_GFSBOX_128_KAT_08 ── */
    {
        .test_id    = "CTR_GFSBOX_128_KAT_08",
        .key        = {
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
        },
        .key_len    = 16,
    ...
    /* ── CTR_GFSBOX_128_KAT_09 ── */
    {
        .test_id    = "CTR_GFSBOX_128_KAT_09",
        .key        = {
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
        },
        .key_len    = 16,
    ...
    /* ── CTR_GFSBOX_128_KAT_10 ── */
    {
        .test_id    = "CTR_GFSBOX_128_KAT_10",
        .key        = {
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
        },
        .key_len    = 16,
    ...
    /* ── CTR_GFSBOX_128_KAT_11 ── */
    {
        .test_id    = "CTR_GFSBOX_128_KAT_11",
        .key        = {
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
        },
        .key_len    = 16,
    ...
    /* ── CTR_GFSBOX_128_KAT_12 ── */
    {
        .test_id    = "CTR_GFSBOX_128_KAT_12",
        .key        = {
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
        },
        .key_len    = 16,
    ...
    /* ── CTR_GFSBOX_128_KAT_13 ── */
    {
        .test_id    = "CTR_GFSBOX_128_KAT_13",
        .key        = {
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
        },
        .key_len    = 16,
    ...
    /* ── CTR_GFSBOX_128_KAT_14 ── */
    {
        .test_id    = "CTR_GFSBOX_128_KAT_14",
        .key        = {
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
        },
        .key_len    = 16,
...
const uint32_t ctr_gfsbox_128_kat_vectors_count = sizeof(ctr_gfsbox_128_kat_vectors) /
                                   sizeof(ctr_gfsbox_128_kat_vectors[0]);

#endif /* AES_128_CTR_GFSBOX_TESTVECTORS_H */