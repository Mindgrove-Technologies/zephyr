...
/* --- 1. Conditional Header Inclusions --- */
#if defined(CONFIG_AES_CTR_KEYSBOX_128)
#include "aes128_ctr_keysbox.h"
#endif

#if defined(CONFIG_AES_CTR_KEYSBOX_192)
#include "aes192_ctr_keysbox.h"
#endif

#if defined(CONFIG_AES_CTR_KEYSBOX_256)
#include "aes256_ctr_keysbox.h"
#endif

/* --- 2. The Unified Test Macro --- */
...
#if defined(CONFIG_AES_CTR_KEYSBOX_128)
    RUN_CTR_BATCH(CTR_KeySbox_128_KAT_Test_Vectors,
                  ctr_keysbox_128_kat_vectors,
                  ctr_keysbox_128_kat_vectors_count,
                  "CTR KEYSbox 128");
#endif

#if defined(CONFIG_AES_CTR_KEYSBOX_192)
    RUN_CTR_BATCH(CTR_KeySbox_192_KAT_Test_Vectors,
                  ctr_keysbox_192_kat_vectors,
                  ctr_keysbox_192_kat_vectors_count,
                  "CTR KEYSbox 192");
#endif

#if defined(CONFIG_AES_CTR_KEYSBOX_256)
    RUN_CTR_BATCH(CTR_KeySbox_256_KAT_Test_Vectors,
                  ctr_keysbox_256_kat_vectors,
                  ctr_keysbox_256_kat_vectors_count,
                  "CTR KEYSbox 256");
#endif
