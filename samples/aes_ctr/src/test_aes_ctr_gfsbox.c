...
#include "aes128_ctr_gfsbox.h"
#include "aes192_ctr_gfsbox.h"
#include "aes256_ctr_gfsbox.h"
...
int test_aes_ctr_gfsbox(void)
{
    ...
    RUN_CTR_BATCH(CTR_GFSbox_128_KAT_Test_Vectors,
                  ctr_gfsbox_128_kat_vectors,
                  ctr_gfsbox_128_kat_vectors_count,
                  "CTR GFSbox 128");

    RUN_CTR_BATCH(CTR_GFSbox_192_KAT_Test_Vectors,
                  ctr_gfsbox_192_kat_vectors,
                  ctr_gfsbox_192_kat_vectors_count,
                  "CTR GFSbox 192");

    RUN_CTR_BATCH(CTR_GFSbox_256_KAT_Test_Vectors,
                  ctr_gfsbox_256_kat_vectors,
                  ctr_gfsbox_256_kat_vectors_count,
                  "CTR GFSbox 256");
