...
#ifndef _SPI_SECIOT__H
#define __SPI_SECIOT__H
...
#define SPI_CFG(dev) ((struct spi_seciot_cfg *) ((dev)->config))
#define SPI_DATA(dev) ((struct spi_seciot_data *) ((dev)->data))
...
struct spi_seciot_data {
	struct spi_context ctx;
};

struct spi_seciot_cfg {
