 ...
 * Name of the file                  : spi_mindgrove.h
...
#ifndef _SPI_MINDGROVE_H
#define __SPI_MINDGROVE_H
...
#define SPI_CFG(dev) ((struct spi_mindgrove_cfg *) ((dev)->config))
#define SPI_DATA(dev) ((struct spi_mindgrove_data *) ((dev)->data))
