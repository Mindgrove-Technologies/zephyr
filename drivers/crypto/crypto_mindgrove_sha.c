...
//  * sha_reg->SHA_INPUT, via the little endian format - both across registers and between
//  * each register. Once the last 64 bits of the sha_reg->SHA_INPUT receive values,
