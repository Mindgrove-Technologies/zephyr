...
{
    printk("ENTERED TEST 1\n");
    printk("reg_index(0x1f) = %u (expected 0)\n", local_irq_to_reg_index(0x1f));
    printk("reg_index(0x20) = %u (expected 1)\n", local_irq_to_reg_index(0x20));
    printk("reg_index(0x3f) = %u (expected 1)\n", local_irq_to_reg_index(0x3f));
    printk("reg_index(0x40) = %u (expected 2)\n", local_irq_to_reg_index(0x40));
...
{
	printk("ENTERED TEST 2 \n");
	printk("reg_index(0x1f) = %u (expected 0)\n", local_irq_to_reg_offset(0x1f));
    printk("reg_index(0x20) = %u (expected 4)\n", local_irq_to_reg_offset(0x20));
    printk("reg_index(0x3f) = %u (expected 4)\n", local_irq_to_reg_offset(0x3f));
    printk("reg_index(0x40) = %u (expected 8)\n", local_irq_to_reg_offset(0x40));
